# AI-lucination: Between Answers and Illusions

<p align="center">
  <img src="https://img.shields.io/badge/Ebook-IA-purple" alt="Ebook IA">
  <img src="https://img.shields.io/badge/ChatGPT-AI_Assisted-10A37F?logo=openai&logoColor=white" alt="ChatGPT">
  <img src="https://img.shields.io/badge/Canva-Design-00C4CC?logo=canva&logoColor=white" alt="Canva">
</p>
...
**AI-lucination: Between Answers and Illusions** é um e-book criado com apoio de Inteligência Artificial sobre o tema das **alucinações de IA**.
...
[📕 Clique aqui para ler o e-book](./output/Ebook%20AI-lucination.pdf)

---

## 💻 Ferramentas utilizadas

- **ChatGPT** — criação do título, estrutura dos capítulos, desenvolvimento dos textos e geração da capa
- **Canva** — diagramação e organização visual do e-book
- **GitHub** — armazenamento, documentação e apresentação do projeto
...
- Explicação simples sobre alucinações de IA
- Exemplos de respostas falsas ou inventadas por IA
- Reflexão sobre pensamento crítico no uso de tecnologia
- Texto em inglês voltado para portfólio e prática profissional
- Capa e diagramação criadas com apoio de ferramentas digitais

---

## 📚 Materiais

- E-book final em `output`
- Prompts utilizados no processo de criação
...
**Enzo C. O. Bittencourt**

[GitHub](https://github.com/ecob5)

---

Projeto desenvolvido como prática de criação de conteúdo com apoio de Inteligência Artificial.
